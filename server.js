...
setInterval(() => {
  http.get(`http://mecodesbot.glitch.me/`);
}, 280000);
...
client.on('ready', () => {
   console.log(`----------------`);
    ...
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`#help-me | Me Codes V5.0.1`,"http://twitch.tv/Me Codes")
...
let Rrole = message.guild.roles.find("id", `603355147422400554`);
if(cooldown.has(message.author.id)){
return message.reply(`**Please wait 10 minutes ** <a:loding5:664564033390903346>`).then(message => {
...
message.channel.send(`**Please help the person ${Rrole}** <:580185227381702676:677203444788101170>`)
}
})
...
client.on('message',message =>{
  ...
  if(message.content.startsWith(prefix+'1buy price')) {
  if(!message.member.hasPermission('MANAGE_GUILD')) return;
  if(!buy[message.guild.id]) buy[message.guild.id] = {
  role:'null',
  price:'null',
